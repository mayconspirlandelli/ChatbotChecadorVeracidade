      ...
      <div className="max-w-[1200px] mx-auto px-5 lg:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {categories.map((cat) => (
            <div
              key={cat.title}
              className="bg-white rounded-lg p-6 shadow-[0_2px_8px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.15)] transition-shadow"
            >
              <div className="w-12 h-12 rounded-lg bg-laranja/10 flex items-center justify-center mb-4">
                <cat.icon className="w-6 h-6 text-laranja" />
              </div>
              <h3 className="text-cinza-escuro font-bold text-lg mb-2">{cat.title}</h3>
